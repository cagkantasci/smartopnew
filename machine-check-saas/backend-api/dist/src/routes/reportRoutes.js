...
// Raporu onayla
router.post("/:id/approve", auth_1.authenticate, (0, role_1.authorizeRoles)("admin", "manager"), reportController_1.approveReport);
// Raporu reddet
router.post("/:id/reject", auth_1.authenticate, (0, role_1.authorizeRoles)("admin", "manager"), reportController_1.rejectReport);
