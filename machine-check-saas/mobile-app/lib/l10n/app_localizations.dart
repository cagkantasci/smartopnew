...
abstract class AppLocalizations {
  ...
  /// No description provided for @errorGettingData.
  ///
  /// In en, this message translates to:
  /// **'Error getting data'**
  String get errorGettingData;
  ...
  /// No description provided for @unnamedEquipment.
  ///
  /// In en, this message translates to:
  /// **'Unnamed Equipment'**
  String get unnamedEquipment;
  ...
  /// No description provided for @equipmentPlate.
  ///
  /// In en, this message translates to:
  /// **'Plate'**
  ...
  /// No description provided for @unnamedReport.
  ///
  /// In en, this message translates to:
  /// **'Unnamed Report'**
  String get unnamedReport;
